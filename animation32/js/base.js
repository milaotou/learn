...
function userAgent() {
	...
	o.isWX=/MicroMessenger/i.test(sUserAgent);
...
function checkTel(string){
    return (/^(([0\+]\d{2,3}-)?(0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/.test(string));
}
...
var _smq = _smq || [];
_smq.push(['_setAccount', '239dfea', new Date()]);
