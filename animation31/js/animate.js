...
function ss(){
	...
	/*$('.doua').from({transform : 'translate(50px , -50px)' , opacity : 0 , delay : 8} ,0.2);	
	$('.doub').from({transform : 'translate(50px , -50px)' , opacity : 0 , delay : 5} ,0.2);	
	$('.douc').from({transform : 'translate(50px , -50px)' , opacity : 0 , delay : 5} ,0.2);	
	$('.doud').from({transform : 'translate(50px , -50px)' , opacity : 0 , delay : 8} ,0.2);	
	...
	$('.ma1').from({ transform : 'translate(50px , -50px)' , opacity : 0 , delay : 8} ,0.2);
	$('.ma2').from({ transform : 'translate(50px , 0px)' , opacity : 0 , delay : 2.5} ,0.2);
	$('.ma3').from({ transform : 'translate(50px , 50px)' , opacity : 0 , delay : 5} ,0.2);
	$('.ma4').from({ transform : 'translate(-50px , 50px)' , opacity : 0 , delay : 5} ,0.2);
	$('.ma5').from({ transform : 'translate(-50px , 0px)' , opacity : 0 , delay : 2.5} ,0.2);
	$('.ma6').from({ transform : 'translate(-50px , -50px)' , opacity : 0 , delay : 8} ,0.2);
